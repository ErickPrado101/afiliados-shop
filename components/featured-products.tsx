        ...
        >
          ...
          <div className="p-4">
            ...
            <div className="flex items-baseline gap-2 mb-3">
              <span className="text-lg font-bold text-white">R$ {produto.preco.toFixed(2)}</span>
              {produto.precoAntigo && (
                <span className="text-sm line-through text-gray-400">R$ {produto.precoAntigo.toFixed(2)}</span>
              )}
            </div>
